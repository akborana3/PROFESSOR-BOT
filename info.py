...
# PyroClient Setup
API_ID = int(environ.get('API_ID', '7546772'))
API_HASH = environ.get('API_HASH', 'b81a0dd9129f5cf3e0011295f2e38724')
BOT_TOKEN = environ.get('BOT_TOKEN', '5605460243:AAGlzjgIVGUZPZ_a7_kP1-b5Z1ujUWXv4bY')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001853830266').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1936371948').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL')
auth_grp = environ.get('AUTH_GROUP', '-1001503592816')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://AKAY:AKAY@akay.qftwfxq.mongodb.net/?retryWrites=true&w=majority")
